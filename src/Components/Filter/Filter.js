    ...
    return (
        <>
            ...
            <div class="flex items-center">
                ...
                <label for="default-radio-2" class="ms-2 text-black font-medium w-20">250-500</label>
            </div>
            ...
            <div class="flex items-center mb-3">
                <input id="default-radio-2" onChange={(event) => setSelected(event.target.value)} type="radio" value='shirt' name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500" />
                <label for="default-radio-2" class="ms-2 font-medium text-black text-md">Shirt</label>
            </div>
            <div class="flex items-center">
